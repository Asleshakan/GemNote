        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Front = table.Column<string>(type: "nvarchar(max)", maxLength: 10000, nullable: false),
                    Back = table.Column<string>(type: "nvarchar(max)", maxLength: 10000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EaseLevel = table.Column<int>(type: "int", nullable: false),
                    NextReviewDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardReviewSessions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardReviewSessions_AppUserId",
                table: "CardReviewSessions",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CardReviewSessions_FlashcardId",
                table: "CardReviewSessions",
                column: "FlashcardId");
